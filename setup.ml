...
(* OASIS_START *)
(* DO NOT EDIT (digest: abc9df62a42ceea7c123f0f2e81f1e4d) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("$omake", ["all"; "NATIVE_ENABLED=$is_native"]))
              ];
            cmd_clean =
              [(OASISExpr.EBool true, Some (("$omake", ["clean"])))];
            cmd_distclean =
              [(OASISExpr.EBool true, Some (("$omake", ["distclean"])))]
         };
     test = [];
     doc = [];
     install =
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/fdopen/cryptohash";
          synopsis = "hash functions for OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "Cryptohash provides OCaml bindings to various cryptographic hash functions written in C"
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\019\241E\254\243\220'\185\242\220\130\"\n\023\185\162";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
